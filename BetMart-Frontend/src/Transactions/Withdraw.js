...
export default function Withdraw() {
  ...
  const [displayCoinsIMg, setDisplayCoinImgs] = useState(withdraw.sol.image);
  const [, setStateNumber] = useState(1);
  const [currency, setDisplayCoinName] = useState(withdraw.sol.name);
      ...
      <div className="withdraw-container">
        <div className="withdraw-content">
          <div className="input-contents">
            <label htmlFor="">Select coin to withdraw from</label>
            <div onClick={showCoinDropDown} className="select-coin">
              <div className="image">
          ...
          {steps && (
            <div onClick={showCoinDropDown} className="dropDownCoin-container">
          ...
          <div className="input-contents">
            <label htmlFor="">Withdraw amount in $usd</label>
          ...
          <div className="input-contents">
            <label htmlFor="">Crypto amount</label>
            <div className="input-amount">
              <h3>209</h3>
            </div>
          </div>
