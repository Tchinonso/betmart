...
import firstNive from '../images/1.svg'
import thirdNive from '../images/3.svg'
    ...
    <div className="homepage-cover">
      <div className="homepage-swipe">
        <div className="content-img-swipe">
          ...
          >
            <SwiperSlide>
              <img src={firstNive} alt="homePic" width={"100%"} />
            </SwiperSlide>
            <SwiperSlide>
              <img src={thirdNive} alt="homePic" width={"100%"} />
            </SwiperSlide>
          </Swiper>
        </div>
      </div>
